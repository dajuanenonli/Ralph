...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'grinder',
                            type: 'image',
                            rect: ['413px', '14px', '142px', '271px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"grinder.svg",'0px','0px']
                        },
                        {
                            id: 'logo',
                            type: 'image',
                            rect: ['142px', '173px', '65px', '50px', 'auto', 'auto'],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("grinding_edgeActions.js");
})("EDGE-15840723");
