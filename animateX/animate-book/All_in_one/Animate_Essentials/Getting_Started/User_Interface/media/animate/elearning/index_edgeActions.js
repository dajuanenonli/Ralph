...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         EC.makeStaticButton(sym.getSymbol("chapterButton2"), "Working with elements", "images/chapterIcon2.png", chapterButton_click, {chapter: 2, description: "Learn how minimal coding skills can change your creative life."});
